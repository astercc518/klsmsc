...
class BalanceLog(Base):
    ...
    change_type = Column(
        Enum("charge", "refund", "deposit", "withdraw", "adjustment", "refund_recharge", "sales_credit", name="balance_change_type"),
        nullable=False,
        comment="变动类型: refund_recharge=退补充值(不计算业绩/成本); sales_credit=销售授信充值"
    )
