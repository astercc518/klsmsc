    ...
    <div class="filter-card">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item :label="$t('accountTemplates.country')">
          <el-input v-model="filters.country_code" :placeholder="$t('accountTemplates.countryCode')" clearable style="width: 120px;" />
        </el-form-item>
    ...
    >
      <el-form :model="form" :rules="rules" ref="formRef" label-width="100px">
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('accountTemplates.countryCode')" prop="country_code">
              <el-input v-model="form.country_code" :placeholder="$t('accountTemplates.countryCodePlaceholder')" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item :label="$t('accountTemplates.countryName')">
              <el-input v-model="form.country_name" :placeholder="$t('accountTemplates.countryNamePlaceholder')" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const rules = computed(() => ({
  ...
  country_code: [{ required: true, message: t('accountTemplates.pleaseEnterCountryCode'), trigger: 'blur' }]
}))
