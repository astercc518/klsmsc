        ...
        <nav class="nav-menu">
          ...
          <template v-if="isStaff">
            ...
            <div class="nav-section" v-if="isFinance">
              ...
              <div class="nav-item" :class="{ active: isActive('/admin/bot/recharge') }" @click="navigate('/admin/bot/recharge')">
                <div class="nav-icon">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <template v-if="isAdmin">
              ...
              <div class="nav-section">
                ...
                <div class="nav-item" :class="{ active: isActive('/admin/bot/recharge') || isActive('/admin/bot/batches') }" @click="navigate('/admin/bot/recharge')">
                  <div class="nav-icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path d="M9 12l2 2 4-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                      <rect x="3" y="3" width="14" height="14" rx="2" stroke="currentColor" stroke-width="1.5"/>
